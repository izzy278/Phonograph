...
public class NextDrawable extends Drawable {
    private static final long PLAY_PAUSE_ANIMATION_DURATION = 250;

    private static final Property<NextDrawable, Float> PROGRESS =
            new Property<NextDrawable, Float>(Float.class, "progress") {
                @Override
                public Float get(@NonNull NextDrawable d) {
                    return d.getProgress();
                }

                @Override
                public void set(@NonNull NextDrawable d, Float value) {
                    d.setProgress(value);
                }
            };
    ...
    public NextDrawable(@NonNull Context context) {
