...
public class PrevDrawable extends Drawable {
    private static final long PLAY_PAUSE_ANIMATION_DURATION = 250;

    private static final Property<PrevDrawable, Float> PROGRESS =
            new Property<PrevDrawable, Float>(Float.class, "progress") {
                @Override
                public Float get(@NonNull PrevDrawable d) {
                    return d.getProgress();
                }

                @Override
                public void set(@NonNull PrevDrawable d, Float value) {
                    d.setProgress(value);
                }
            };
    ...
    public PrevDrawable(@NonNull Context context) {
